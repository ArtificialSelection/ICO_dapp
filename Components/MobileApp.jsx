          ...
          <div className="col-lg-7 col-md-12 col-sm-12">
            <div className="title_default_light title_border text_md_center">
              ...
              >
                ...
                Laborum sapiente rerum aut fugit iste? Delectus repudiandae
                magnam, at molestias dolores doloremque iusto quaerat nobis
                quibusdam laudantium maiores blanditiis? Delectus, nobis!
              </p>
              <p
                className="animation"
                data-animation="fadeInUp"
