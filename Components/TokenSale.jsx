          ...
          <div className="col-lg-6 offset-lg-3 col-md-12 col-sm-12">
            <div className="title_default_light title_border text-center">
              ...
              >
                ...
                voluptas mollitia voluptatem possimus iure quibusdam magni
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="row align-items-center">
                ...
                <div className="tk_counter_inner">
                  ...
                  >
                    ...
                    <span className="progress_label bg-white inline_style_1">
                      <strong>{tokenSale?.tokenSold} AS</strong>
                    </span>
                    <span className="progress_label bg-white inline_style_2">
                      <strong>{tokenSale?.tokenSaleBalance} AS</strong>
                    </span>
          ...
          <div className="col-lg-3">
            ...
            <div className="pr_box">
              ...
              >
                {" "}
                {tokenSale?.tokenSold} AS {showPercentage.slice(0, 4)}%
              </p>
            </div>
            <div className="pr_box">
              <h6
